...
- Create a `your_feature.template.fsharp.injection` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.template.fsharp.injection",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.template.fsharp.injection"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.template.fsharp.injection"
        }
    },
    "name": "support.other.attribute.template.fsharp.injection",
    "patterns": [
        {
